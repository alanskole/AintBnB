...
{
    public sealed partial class AllAccommodationsInTheSystemPage : Page
    {
        public AccommodationViewModel ViewModel { get; } = new AccommodationViewModel();
        public AuthenticationViewModel AuthenticationViewModel { get; } = new AuthenticationViewModel();

        public AllAccommodationsInTheSystemPage()
        {
        ...
        private async void Page_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                await AuthenticationViewModel.IsCurrentUserAdmin();
        ...
        private async void listView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            Frame.Navigate(typeof(AllAccommodationsInTheSystemPage));
        }
    }
}
